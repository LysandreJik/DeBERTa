...
| [DeBERTa-XLarge-V2](https://huggingface.co/microsoft/deberta-xlarge-v2)<sup>3</sup>| -| -|91.7/91.6| **97.5**| 95.8|71.1|93.9|92.0/94.2| -    |92.9/92.9|
...
--------
##### Notes.
 - <sup>1</sup> For RTE, MRPC, STS-B, we fine-tune the task based on [DeBERTa-Large-MNLI](https://huggingface.co/microsoft/deberta-large-mnli).
 - <sup>2</sup> For RTE, MRPC, STS-B, we fine-tune the task based on [DeBERTa-XLarge-MNLI](https://huggingface.co/microsoft/deberta-xlarge-mnli).
 - <sup>3</sup> For RTE, MRPC, STS-B, we fine-tune the task based on [DeBERTa-XLarge-V2-MNLI](https://huggingface.co/microsoft/deberta-xlarge-v2-mnli).
 - <sup>4</sup> For RTE, MRPC, STS-B, we fine-tune the task based on [DeBERTa-XXLarge-V2-MNLI](https://huggingface.co/microsoft/deberta-xxlarge-v2-mnli).
